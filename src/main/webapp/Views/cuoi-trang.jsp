    ...
    <div class="footer-top-area">
        ...
        <div class="container">
            <div class="row">
                ...
                <c:if test="${empty sessionScope.nd }">
                	<div class="col-md-3 col-sm-6">
                    	<div class="footer-menu">
                        	<h2 class="footer-wid-title">Đăng nhập</h2>
                        	<form action="javascript:dangNhap()" method="post">
                        		<p><input type="text" name="email" placeholder="Nhập email" id="email"></p>
                        		<p><input type="password" name="password" placeholder="Nhập password" id="password"></p>
