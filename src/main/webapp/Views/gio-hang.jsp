                                    ...
                                    <tbody>
                                    	<c:forEach items="${lstSP }" var="sp">
                                            ...
                                            <td class="product-price">
                                                <span class="amount">${sp.donGia } đ</span> 
                                            </td>

                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <input type="button" class="minus" value="-">
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="${sp.inCart }" min="0" step="1">
                                                    <input type="button" class="plus" value="+">
                                                </div>
                                            </td>

                                            <td class="product-subtotal">
                                                <span class="amount">${sp.inCart*sp.donGia } đ</span> 
                                            </td>
                                        </tr>
                                    	</c:forEach>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><span class="amount">${sessionScope.cart.getTotal() }</span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Tổng cộng</th>
                                            <td><strong><span class="amount">${sessionScope.cart.getTotal() }</span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
