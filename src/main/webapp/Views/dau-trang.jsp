   		...
   		function dangNhap(){
   			...
   			xhr.onreadystatechange=function(){
   				if (this.readyState==4 && this.status==200){
   					...
   					document.getElementById("username").innerHTML="Xin chào : "+name;
   				}
   			}
   			xhr.open("POST","DangNhapServlet");
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="DanhSachGioHang">Giỏ hàng: <span class="cart-amunt" id="total-money">đ</span> <i class="fa fa-shopping-cart"></i> <span class="product-count" id="product-count"></span></a>
                    </div>
                </div>
            </div>
        </div>
